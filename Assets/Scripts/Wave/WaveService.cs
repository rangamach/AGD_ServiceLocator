...
namespace ServiceLocator.Wave
{
    public class WaveService
    {
        ...
        private void SubscribeToEvents() => GameService.Instance.event_service.OnMapSelected.AddListener(LoadWaveDataForMap);
        ...
        public void StarNextWave()
        {
            ...
            var spawnPosition = GameService.Instance.map_service.GetBloonSpawnPositionForCurrentMap();
        ...
        public async void SpawnBloons(List<BloonType> bloonsToSpawn, Vector3 spawnPosition, int startingWaypointIndex, float spawnRate)
        {
            foreach(BloonType bloonType in bloonsToSpawn)
            {
                ...
                bloon.SetWayPoints(GameService.Instance.map_service.GetWayPointsForCurrentMap(), startingWaypointIndex);
        ...
        public void RemoveBloon(BloonController bloon)
        {
            ...
            {
                GameService.Instance.sound_service.PlaySoundEffects(Sound.SoundType.WaveComplete);
                GameService.Instance.UIService.UpdateWaveProgressUI(currentWaveId, waveDatas.Count);
