...
namespace ServiceLocator.Player
{
    public class PlayerService
    {
        ...
        public void Update()
        {
            ...
            {
                foreach (MonkeyController monkey_controller in activeMonkeys)
                    monkey_controller.UpdateMonkey();
            }
        ...
        public void ValidateSpawnPosition(int monkeyCost, Vector3 dropPosition)
        {
            ...
            GameService.Instance.map_service.ValidateSpawnPosition(dropPosition);
        }
        ...
        public void TrySpawningMonkey(MonkeyType monkeyType, int monkeyCost, Vector3 dropPosition)
        {
            ...
            if (GameService.Instance.map_service.TryGetMonkeySpawnPosition(dropPosition, out Vector3 spawnPosition))
            {
                SpawnMonkey(monkeyType, spawnPosition);
                GameService.Instance.sound_service.PlaySoundEffects(SoundType.SpawnMonkey);
            }
        }
