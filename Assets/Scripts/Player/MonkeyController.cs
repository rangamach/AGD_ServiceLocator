...
namespace ServiceLocator.Player
{
    public class MonkeyController
    {
        ...
        public MonkeyController(MonkeyScriptableObject monkeyScriptableObject, ProjectilePool projectilePool, SoundService sound_service)
        {
        ...
        private void ShootAtTarget(BloonController targetBloon)
        {
            ...
            if(attackTimer <= 0)
            {
                ...
                sound_service.PlaySoundEffects(Sound.SoundType.MonkeyShoot);
                ResetAttackTimer();
            }
        }
